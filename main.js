...
var btn2222 = document.querySelector('button2222');
...
var divBuyCOIN_USDPZM = document.querySelector('.buyCOIN_USDPZM span');
var divSellCOIN_USDPZM = document.querySelector('.sellCOIN_USDPZM span');
//var divBuyCOIN_USD_livecoinPZM = document.querySelector('.buyCOIN_USD_livecoinPZM span');
//var divSellCOIN_USD_livecoinPZM = document.querySelector('.sellCOIN_USD_livecoinPZM span');
var divBuyCOIN_USD_hotbitPZM = document.querySelector('.buyCOIN_USD_hotbitPZM span');
var divSellCOIN_USD_hotbitPZM = document.querySelector('.sellCOIN_USD_hotbitPZM span');


var PROFIT = document.querySelector('.PROFIT span');
...
//btn2222.addEventListener('click', () => {
 ...
 btn.addEventListener('click', () => {  
   ...
   var kyrsBTCUSD = $('#kyrsBTCUSD').val();
var kyrsBTCUSD2020 = (kyrsBTCUSD);
   
   
 var min_transaction22p = $('#min_transaction22p').val();
   var min_transaction22pp = (min_transaction22p);
 var min_trans22p = $('#min_trans22p').val();
   var min_trans22pp = (min_trans22p);
 var QQQ7 = (min_transaction22pp*100/min_trans22pp-100).toFixed(2);
     PROFIT.innerHTML = QQQ7;  
...
//v//ar value12 = (((currentPrice_SellCOIN_USD*100)/currentPrice_SellCOIN_USD_livecoin)-100).toFixed(2);   
...
//  })
 // .catch(err => console.log(err)); 
  ...
  .catch(err => console.log(err)); 
   ...
   var QQQ1 = (currentPrice_BuyCOIN_USD*kyrsBTCUSD2020).toFixed(8);
     divBuyCOIN_USDPZM.innerHTML = QQQ1;
   var QQQ2 = (currentPrice_SellCOIN_USD*kyrsBTCUSD2020).toFixed(8);
     divSellCOIN_USDPZM.innerHTML = QQQ2;
 // var QQQ3 = (currentPrice_BuyCOIN_USD_livecoin*kyrsBTCUSD2020).toFixed(8);
    // divBuyCOIN_USD_livecoinPZM.innerHTML = QQQ3;
	// var QQQ4 = (currentPrice_SellCOIN_USD_livecoin*kyrsBTCUSD2020).toFixed(8);
   //  divSellCOIN_USD_livecoinPZM.innerHTML = QQQ4;
   var QQQ5 = (currentPrice_BuyCOIN_USD_hotbit*kyrsBTCUSD2020).toFixed(8);
     divBuyCOIN_USD_hotbitPZM.innerHTML = QQQ5;
   var QQQ6 = (currentPrice_SellCOIN_USD_hotbit*kyrsBTCUSD2020).toFixed(8);
     divSellCOIN_USD_hotbitPZM.innerHTML = QQQ6;
...
document.getElementById('out1').innerHTML = result1.toFixed(8);
...
var text7 = "%0AБаланс:" + ' ' + (document.getElementById('out1').innerHTML) + ' ' + "BTC";
